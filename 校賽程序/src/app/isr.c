...
//        enable_irq(90); 
//    }
  if(PORTD_ISFR & (1<<11))//读取LDC1614数据
  {
//按键中断1的中断服务
    LdcRead();
...
void PIT0_IRQHandler()
{
  ...
  static unsigned char TimeCnt_20ms = 0,TimeCnt_5ms=0,TimeCnt_10ms=0;	  //5ms,20ms时间计数器    
  static unsigned int  TimeCnt_3000ms = 0,TimeCnt_2000ms = 0;
...
//****************************************************测速函数
  if(TimeCnt_20ms==3)//&&Blue_Start_Flag==1)//20ms执行一次
  {
//    if(Init_Speed_flag==0)
//    {
      Get_speed1(&Motor1);
      Get_speed2(&Motor2);
      Speed_Control();
  ...
  //  {
    ...
    //}
//    if(abs_s16(Motor2.Speed-Motor1.Speed)>=4)
//      BEEP=1;
//    else
//      BEEP=0;
  }
  ...
  if(TimeCnt_20ms==1)
  {
      ...
      ldc1614_result[0]=LDC1614_Result(0);
      ldc1614_result[1]=LDC1614_Result(1);
      if(ldc1614_result[0]>(ldc1614_init0+1))//左转
      {
        Left_Turn=1;
        Right_Turn=0;
        Go_straight=0;
      }
      if(ldc1614_result[1]>ldc1614_init1)//右转
      {
        Right_Turn=1;
        Left_Turn = 0;
        Go_straight=0;
...
//      if(((ldc1614_result[0]==ldc1614_init0)||(ldc1614_result[0]==ldc1614_init0+1))&&((ldc1614_result[1]==ldc1614_init1)||(ldc1614_result[1]==ldc1614_init1+1)))
//      {
//        Go_straight=1;
//        Left_Turn = 0;
//        Right_Turn = 0;
//      }
    ...
    //ldc1614_result[2]=LDC1614_Result(2);
    //ldc1614_result[3]=LDC1614_Result(3);
//    LdcRead();
  }
  if(TimeCnt_20ms==2)
  {
    ...
    //{
      if(Left_Turn==1)
      {
        LED1=0;
        LED2=1;
        Speed_goal1=Master_Speed-Differ_Speed;
        Speed_goal2=Master_Speed+Differ_Speed;
      }
       if(Right_Turn==1)
      {
        LED2=0;
...
//      {
//        LED1=LED2=1;
//        Speed_goal1=Speed_goal2=Master_Speed;
//      }
    //}
    
//    if(ldc1614_result[0]>(ldc1614_init0))//左转
//    {
//      //ldc_temp=1;
//      LED1=0;
//      //BEEP=1;
//      while(ldc1614_result[1]==ldc1614_init1)
//      {
//        Speed_goal1=Master_Speed-Differ_Speed;
//        Speed_goal2=Master_Speed+Differ_Speed;
//      }
...
//      //ldc_temp=1;
//      LED2=0;
//      while(ldc1614_result[0]==(ldc1614_init0))
//      {
//        Speed_goal1=Master_Speed+Differ_Speed;
//        Speed_goal2=Master_Speed-Differ_Speed;
//      }
//    }
//     if(((ldc1614_result[0]==ldc1614_init0))&&(ldc1614_result[1]==ldc1614_init1))//直行
//    {
//      //ldc_temp=0;
//      LED1=LED2=1;
//      Speed_goal1=Speed_goal2=Master_Speed;
//    }
//    if(((ldc1614_result[0]==ldc1614_init0)||(ldc1614_result[0]==ldc1614_init0+1))&&(ldc1614_result[1]==ldc1614_init1))
//    {
//      ldc_temp=0;
//      LED1=LED2=1;
//      Speed_goal1=Speed_goal2=Master_Speed;
//    }
//    if(ldc1614_result[1]==ldc1614_init1)
//    {
//      LED2=1;
//      Speed_goal1=Speed_goal2=Master_Speed;
//    }
//    if((ldc1614_result[2]>ldc1614_init2)||(ldc1614_result[3]>ldc1614_init3))
//    {
//      ldc_temp=1;
//    }
//    if((ldc1614_result[0]==ldc1614_init0)&&(ldc1614_result[1]==ldc1614_init1)&&(ldc1614_result[2]==ldc1614_init2)&&(ldc1614_result[3]==ldc1614_init3))
//    {
//      ldc_temp=0;
//    }
  }
